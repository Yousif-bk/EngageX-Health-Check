...
def authResponse = WS.sendRequest(findTestObject('Nexus/Interfaces/Auth API OR'))
...
def smsResponse = WS.sendRequest(findTestObject('Nexus/Interfaces/Non Bulk API OR', [('authToken') : token]))
