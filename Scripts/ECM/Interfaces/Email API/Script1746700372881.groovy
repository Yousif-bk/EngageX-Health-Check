...
//WS.sendRequest(findTestObject('ECM/Interfaces/Email API OR', [('jwt_token') : '']))

def authResponse = WS.sendRequest(findTestObject('ECM/Interfaces/Auth API OR'))
...
def smsResponse = WS.sendRequest(findTestObject('ECM/Interfaces/Email API OR', [('jwt_token') : token]))
